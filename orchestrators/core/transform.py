...
def extract_post_fields(d: Dict[str, Any]) -> Tuple[Optional[int], Optional[int], Optional[int], Optional[int], Optional[int], str, str]:
    ...
    return id, parent_id, like_count, repost_count, reply_count, content, author_username